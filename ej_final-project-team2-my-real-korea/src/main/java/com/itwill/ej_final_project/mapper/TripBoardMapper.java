...
public interface TripBoardMapper {
	 ...
	 */
	List<TripBoard> selectAllTb(Map<String, Object> tbPageMap) throws Exception;
	 ...
	 * 키워드로 검색된 동행게시판 리스트
	 */
	List<TripBoard> selectSearchTbList(Map<String, Object> tbKeywordPageMap) throws Exception;
